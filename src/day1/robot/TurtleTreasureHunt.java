package day1.robot;
	...
	public class TurtleTreasureHunt implements KeyEventDispatcher {
		...
		private void spaceBarWasPressed() {
			...
			if (tortoiseLocationX==505 && tortoiseLocationY==330) {
			JOptionPane.showMessageDialog(null, "what you are looking for is in a hut but not any normal hut its in the... You know what just ask bill he knows more he is that boy over there.");	
			}
			// 7. Give the user subsequent clues at different locations on the image
			// (pirate robot, swamp, parrots, etc.)
			if (tortoiseLocationX==140 && tortoiseLocationY==305) {
				JOptionPane.showMessageDialog(null, "Hello there i'm bill I heard that you were looking for the treasure well it is in that old war hut by the canon i wish you good luck.");	
				}
			
			
			
			
			if (tortoiseLocationX==495 && tortoiseLocationY==185) {
